...
<template>
    ...
    <nav class="bg-light-primary border-gray-200 dark:bg-dark-secondary">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="w-full md:block md:w-auto"
                 ...
                 id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-light-secondary md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-dark-secondary md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white bg-light-tail-500 dark:bg-dark-navy-100 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">Home</a>
                    </li>
                    <li>
