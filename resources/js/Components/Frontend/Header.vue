<template>
    <Disclosure as="nav" class="bg-dark-secondary shadow" v-slot="{ open }">
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="hidden md:ml-6 md:flex md:space-x-8 ">
                            ...
                            <a href="#" class="inline-flex items-center border-b-2 border-dark-navy-100 px-1 pt-1 text-sm font-medium text-blue-accent">Dashboard</a>
                            <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-dark-accent">Team</a>
                            <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-dark-accent">Projects</a>
                            <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-dark-accent">Calendar</a>
                        </div>
